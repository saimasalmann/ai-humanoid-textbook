...
## Active Technologies
- Markdown, Python 3.8+ for code examples, JavaScript/TypeScript for Docusaurus customization + Docusaurus, Node.js 18+, npm/yarn, ROS 2 (Humble Hawksbill or later), Gazebo, NVIDIA Isaac Sim (001-ai-humanoid-textbook)
